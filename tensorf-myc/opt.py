...
def config_parser(cmd=None):
    ...
    parser.add_argument('--bg_freq', type=int, default=4,
                        help='bg pos pe')
    parser.add_argument('--bg_view_freq', type=int,default=2,
                        help='bg view pe')
    parser.add_argument('--bg_D', type=int,default=4,
                        help='background MLP depth')
    parser.add_argument('--radii', type=float,default=20,
                        help='radii')
    parser.add_argument('--normal_vector_penalty_weight', type=float ,default=0.,
                        help='normal_vector_penalty_weight')
                        
    
    parser.add_argument('--bbox', type=float,
                        help='bbox',action="append")
    parser.add_argument('--near', type=float,
                        help='near')
    parser.add_argument('--far', type=float,
                        help='far')
    parser.add_argument('--gc_every', type=int, default=20,
                        help='gc_every')
    ...
    parser.add_argument('--model_name', type=str, default='TensorVMSplit',
                        choices=['TensorVMSplit', 'TensorCP', "NerfPlusPlus", "REFTensoRF"])
